...
//         <h1 className="font-bold text-xl text-primary hidden sm:block">Ride2Share</h1>
//       </NavLink>
...
//   return (
//     // <header className="sticky top-0 z-50 w-full border-b backdrop-blur-md bg-background/80  flex p-3 lg:px-16 items-center justify-end shadow-sm rounded-full mx-4 mt-4">
//     <header className="sticky top-0 z-50 w-[95%] mx-auto mt-4 rounded-full backdrop-blur-md bg-background/80 flex p-3 lg:px-16 items-center justify-end shadow-[0px_4px_24px_rgba(59,130,246,0.15)] ">
